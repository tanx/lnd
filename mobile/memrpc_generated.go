...
// walletUnlockerLis is a global in-memory buffer that listeners that is referenced by
// the generated mobile APIs, such that all client calls will be going through
// it.
var walletUnlockerLis = bufconn.Listen(100)

// lightningLis is a global in-memory buffer that listeners that is referenced by
// the generated mobile APIs, such that all client calls will be going through
// it.
var lightningLis = bufconn.Listen(100)
